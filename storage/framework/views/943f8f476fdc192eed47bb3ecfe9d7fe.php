<?php $__env->startSection('content'); ?>
    ...
    <div id="banner-section" class="section-spacing-bottom px-0">
        <?php if( $is_enable_banner == 1): ?>
        <?php echo $__env->make('frontend::components.section.banner', ['data' => $sliders ?? []], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
    </div>
    ...
    <div class="container-fluid padding-right-0">
        <div class="overflow-hidden">
           ...
           ?>
            ...
            <?php if($user_id !=null && $is_enable_continue_watching == 1): ?>
         ...
         <div id="language-section" class="section-wraper scroll-section section-hidden">
            <div class="card-style-slider movie-shimmer">
                <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 mt-3">
                   <?php for($i = 0; $i < 6; $i++): ?>
                     <div class="shimmer-container col mb-3">
                         <?php echo $__env->make('components.card_shimmer_languageList', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                     </div>
                  <?php endfor; ?>
              </div>
           </div>
      ...
      <?php if(isenablemodule('livetv')==1 ): ?>
      <div id="topchannel-section" class="section-wraper scroll-section section-hidden">
        <div class="card-style-slider shimmer-container">
            <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 mt-3">
                    <?php for($i = 0; $i < 6; $i++): ?>
                        <div class="shimmer-container col mb-3">
                                <?php echo $__env->make('components.card_shimmer_channel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    <?php endfor; ?>
              </div>
          </div>
   ...
   <div id="favorite-personality" class="section-wraper scroll-section section-hidden">
    <div class="card-style-slider shimmer-container">
        <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 row-cols-xl-7 mt-3">
                <?php for($i = 0; $i < 7; $i++): ?>
                    <div class="shimmer-container col mb-3">
                            <?php echo $__env->make('components.card_shimmer_crew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                <?php endfor; ?>
        </div>
    </div>
...
<div id="genres-section" class="section-wraper scroll-section section-hidden">
    <div class="card-style-slider shimmer-container">
        <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 mt-3">
                <?php for($i = 0; $i < 6; $i++): ?>
                    <div class="shimmer-container col mb-3">
                            <?php echo $__env->make('components.card_shimer_genres', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                <?php endfor; ?>
        </div>
    </div>
...
<?php endif; ?>
   ...
   <?php if( $user_id != null && isenablemodule('movie')==1): ?>
...
<?php echo $__env->make('frontend::layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u709483251/domains/madhutechnoworld.in/public_html/Modules/Frontend/Resources/views/index.blade.php ENDPATH**/ ?>
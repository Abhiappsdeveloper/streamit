    ...
    <div class="row mt-3">
        <div class="col-lg-8">
            <div class="row">
                ...
                <a href="<?php echo e(route('backend.users.index')); ?>">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($totalusers); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_total_users')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6">
                    <a href="<?php echo e(route('backend.subscriptions.index')); ?>">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="card-icon mb-5 fs-1">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($totalSubscribers); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_total_subscribers')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6">
                <a href="<?php echo e(route('backend.users.index', ['type' => 'soon-to-expire'])); ?>">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="card-icon mb-5 fs-1">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($totalsoontoexpire); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_soon_to_expire')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
...
<div class="col-md-4 col-sm-6">
    <a href="<?php echo e(route('backend.reviews.index')); ?>">
        <div class="card card-stats">
            <div class="card-body">
...
<rect width="45" height="45" fill="white" transform="translate(0.769531)"/>
                ...
                <div class="card-data">
                    <h1 class=""><?php echo e($totalreview); ?></h1>
                    <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_review')); ?></p>
                </div>
            </div>
        </div>
    </a>
                ...
                <a >
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($totalUsageFormatted); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_storage_full')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                ...
                <a href="#">
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($count_of_rent_movie + $count_of_rent_episode); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_rent_content')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                 ...
                 <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e(Currency::format( $subscription_revenue)); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('messages.lbl_total_subscription_revenue')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                  ...
                  <div class="col-md-4 col-sm-6">
                    <a href="<?php echo e(route('backend.pay-per-view-history')); ?>">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="card-icon mb-5 fs-1">
                                <i class="ph ph-money"></i>
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e(Currency::format( $rent_revenue)); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('messages.lbl_total_rent_revenue')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e(Currency::format( $total_revenue)); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_total_revenue')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6">
                <a href="<?php echo e(route('backend.movies.index')); ?>">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="card-icon mb-5 fs-1">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($totalmovies); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_total_movies')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6">
                <a href="<?php echo e(route('backend.tvshows.index')); ?>">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="card-icon mb-5 fs-1">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($totaltvshow); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_total_shows')); ?></p>
                            </div>
                        </div>
                    </div>
                    </a>
                ...
                <?php endif; ?>
                <?php if(isenablemodule('video')==1): ?>
                <div class="col-md-4 col-sm-6">
                <a href="<?php echo e(route('backend.videos.index')); ?>">
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="card-icon mb-5 fs-1">
                            ...
                            <div class="card-data">
                                <h1 class=""><?php echo e($totalvideo); ?></h1>
                                <p class="mb-0 fs-6"><?php echo e(__('dashboard.lbl_total_videos')); ?></p>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="col-lg-4">
            <div class="card card-stats">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('dashboard.lbl_top_genres')); ?></h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card card-stats card-block card-height">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <h3 class="card-title"><?php echo e(__('dashboard.lbl_tot_revenue')); ?></h3>
                    <div class="dropdown">
        ...
        <div class="col-md-6">
            <div class="card card-stats card-block card-height">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <h3 class="card-title"><?php echo e(__('dashboard.new_subscribers')); ?></h3>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-soft-primary sub-dropdown" aria-labelledby="dropdownNewSubscribers">
                            <li><a class="subscribers-dropdown-item dropdown-item" data-type="Year"><?php echo e(__('dashboard.year')); ?></a></li>
                            <li><a class="subscribers-dropdown-item dropdown-item" data-type="Month"><?php echo e(__('dashboard.month')); ?></a></li>
                            <li><a class="subscribers-dropdown-item dropdown-item" data-type="Week"><?php echo e(__('dashboard.week')); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card card-block card-height">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <h3 class="card-title"><?php echo e(__('dashboard.lbl_most_watched')); ?></h3>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-soft-primary sub-dropdown" aria-labelledby="dropdownMostWatch">
                            <li><a class="mostwatch-dropdown-item dropdown-item" data-type="Year"><?php echo e(__('dashboard.year')); ?></a></li>
                            <li><a class="mostwatch-dropdown-item dropdown-item" data-type="Month"><?php echo e(__('dashboard.month')); ?></a></li>
                            <li><a class="mostwatch-dropdown-item dropdown-item" data-type="Week"><?php echo e(__('dashboard.week')); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
...
<div class="col-md-6">
    <div class="card card-stats card-block card-height">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
            <h3 class="card-title"><?php echo e(__('customer.reviews')); ?></h3>
            <a href="<?php echo e(route('backend.reviews.index')); ?>"><?php echo e(__('dashboard.view_all')); ?></a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table">
                    <thead class="text-primary">
                        ...
                        <th><?php echo e(__('dashboard.rating')); ?></th>
                    </thead>
                    <tbody>
                        <?php if($reviewData): ?>
                        <?php $__currentLoopData = $reviewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           <td class="d-flex gap-3 align-items-center">
    <?php if(optional($review->user)): ?>
        <a href="<?php echo e(url('/app/users/details/' . $review->user->id)); ?>" class="d-flex gap-3 align-items-center text-decoration-none">
            <img src="<?php echo e(setBaseUrlWithFileName($review->user->file_url) ?? default_user_avatar()); ?>" alt="avatar" class="avatar avatar-40 rounded-pill">
            <div class="text-start">
                <h6 class="m-0"><?php echo e($review->user->first_name . ' ' . $review->user->last_name); ?></h6>
                <small class="text-white"><?php echo e($review->user->email); ?></small>
            </div>
        </a>
    <?php else: ?>
        <div class="d-flex gap-3 align-items-center">
            <img src="<?php echo e(default_user_avatar()); ?>" alt="avatar" class="avatar avatar-40 rounded-pill">
            <div class="text-start">
                <h6 class="m-0"><?php echo e(default_user_name()); ?></h6>
    ...
    <?php endif; ?>
                            ...
                            <td><?php echo e($review->created_at ? formatDate($review->created_at->format('Y-m-d')) : ''); ?></td>
                            <td><?php echo e(ucfirst(optional($review->entertainment)->type)); ?></td>
                            <td>
                                <div class="d-flex gap-3 align-items-center">
                                    <div class="star-rating">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <span class="star <?php echo e($i <= $review->rating ? 'filled' : ''); ?>">
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="5"><?php echo e(__('messages.no_data_available')); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="card card-block card-height">
                        <div class="card-header card-header-primary">
                            <h3 class="card-title"><?php echo e(__('dashboard.lbl_top_rated')); ?></h3>
                        </div>
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="card card-block card-height">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <h3 class="card-title"><?php echo e(__('dashboard.transaction_history')); ?></h3>
                            <a href="<?php echo e(route('backend.subscriptions.index')); ?>"><?php echo e(__('dashboard.view_all')); ?></a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead class="text-primary">
                                        <th><?php echo e(__('dashboard.name')); ?></th>
                                        <th><?php echo e(__('dashboard.date')); ?></th>
                                        <th><?php echo e(__('dashboard.plan')); ?></th>
                                        <th><?php echo e(__('dashboard.amount')); ?></th>
                                        <th><?php echo e(__('dashboard.duration')); ?></th>
                                        <th><?php echo e(__('dashboard.payment_method')); ?></th>
                                    </thead>
                                    <tbody>

                                        <?php $__currentLoopData = $subscriptionData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                         <td>
                                            <a href="<?php echo e($subscription->user ? route('backend.users.details', $subscription->user->id) : '#'); ?>"
                                                class="d-flex gap-3 align-items-center text-decoration-none text-dark <?php echo e($subscription->user ? '' : 'disabled'); ?>">
        <img src="<?php echo e(setBaseUrlWithFileName(optional($subscription->user)->file_url) ?? default_user_avatar()); ?>" alt="avatar" class="avatar avatar-40 rounded-pill">
        <div class="text-start">
            <h6 class="m-0">
                <?php echo e(optional($subscription->user)->first_name .' '. optional($subscription->user)->last_name  ?? default_user_name()); ?>

            </h6>
            <small class="text-dark"> <!-- ensure email is white or dark, depending on your theme -->
                <?php echo e(optional($subscription->user)->email ?? '--'); ?>

            </small>
        </div>
    </a>
</td>
                                            <td><?php echo e($subscription->is_manual == 1 ? (optional($subscription->start_date) ? \Carbon\Carbon::parse($subscription->start_date)->format('d F Y') : '--') : (optional($subscription->subscription_transaction?->created_at) ? \Carbon\Carbon::parse($subscription->subscription_transaction->created_at)->format('d F Y'): '--')); ?></td>
                                            <td><?php echo e($subscription->name); ?></td>
                                            <td><?php echo e(Currency::format($subscription->total_amount)); ?></td>
                                            <td><?php echo e($subscription->duration. ' ' . optional($subscription->plan)->duration); ?></td>
                                            <td><?php echo e(ucfirst(optional($subscription->subscription_transaction)->payment_type)); ?></td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($subscriptionData->isEmpty()): ?>
                                        <tr>
                                            <td colspan="5"><?php echo e(__('messages.no_data_available')); ?></td>
                                        </tr>
                                        <?php endif; ?>
...
<?php echo $__env->make('backend.layouts.app', ['isBanner' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u709483251/domains/madhutechnoworld.in/public_html/resources/views/backend/dashboard/index.blade.php ENDPATH**/ ?>
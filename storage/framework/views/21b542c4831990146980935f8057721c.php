<?php if(auth()->check()): ?>
<div id="custom-ad-banner-section-<?php echo e($placement ?? 'default'); ?>" class="section-wraper section-hidden">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var contentId = "<?php echo e($content_id ?? ''); ?>";
    var contentType = "<?php echo e($content_type ?? ''); ?>";
    var categoryId = "<?php echo e($category_id ?? ''); ?>";
    ...
    fetchCustomAdBanner(<?php echo json_encode($placement ?? 'default', 15, 512) ?>, 'custom-ad-banner-section-<?php echo e($placement ?? 'default'); ?>');
});
</script>
<style>
...
</style><?php /**PATH /home/u709483251/domains/madhutechnoworld.in/public_html/Modules/Frontend/Resources/views/components/section/custom_ad_banner.blade.php ENDPATH**/ ?>
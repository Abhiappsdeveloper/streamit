    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h5 class="mb-2"><?php echo e(__('frontend.share_movie_experience')); ?></h5>
                <p class="m-0"><?php echo e(__('frontend.share_your_thoughts')); ?></p>
                ...
                <div class="mt-5 pt-3">
                    <form class="m-0" id="reviewForm">
                        <ul class="list-inline m-0 p-0 d-flex align-items-center justify-content-center gap-3 rating-list">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <li data-value="<?php echo e($i); ?>" class="star">
                        ...
                        <div class="mt-5 pt-2">
                            <button type="submit" class="btn btn-primary" id="submitBtn"><?php echo e(__('frontend.submit')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function () {
    ...
    $('#reviewForm').on('submit', function (event) {
        ...
        const url = reviewId
            ? '<?php echo e(route('update-rating')); ?>?is_ajax=1'
            : '<?php echo e(route('save-rating')); ?>?is_ajax=1';
        ...
        $.ajax({
            ...
            complete: function () {
                isSubmitting = false;
                submitBtn.prop('disabled', false).html('<?php echo e(__('frontend.submit')); ?>');
            }
        });
    });
});
...
<?php /**PATH /home/u709483251/domains/madhutechnoworld.in/public_html/Modules/Frontend/Resources/views/components/section/add_review.blade.php ENDPATH**/ ?>
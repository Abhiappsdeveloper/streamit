...
?>
<nav
class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu left-border <?php echo e(!empty(getCustomizationSetting('navbar_show')) ? getCustomizationSetting('navbar_show') : ''); ?> <?php echo e(getCustomizationSetting('header_navbar')); ?>">
            ...
            <ul class="navbar-nav ms-auto align-items-center navbar-list gap-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link d-flex align-items-center p-0" data-bs-toggle="dropdown" href="#"
                        ...
                        <img src="<?php echo e(asset('flags/' . App::getLocale() . '.png')); ?>" alt="flag" class="img-fluid me-2"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link p-0" data-bs-toggle="dropdown" href="#" role="button"
                        ...
                        <div class="avatar avatar-md">
                            <img class="avatar avatar-40 img-fluid rounded-pill" src="<?php echo e(setBaseUrlWithFileName(auth()->user()->file_url)); ?>"
                    ...
                    <ul class="dropdown-menu sub-drop dropdown-menu-end">
                        <div class="dropdown-header bg-primary-subtle py-3 rounded">
                            <div class="d-flex gap-2">
                                <img class="avatar avatar-40 img-fluid rounded-pill"
                                    src="<?php echo e(setBaseUrlWithFileName(auth()->user()->file_url)); ?>" />
                                <div class="d-flex flex-column align-items-start">
                                    <h5 class="m-0 text-primary"><?php echo e(Auth::user()->full_name ?? default_user_name()); ?>

                                    </h5>
                                    <span class="text-muted"><?php echo e(Auth::user()->email ?? 'abc@email.com'); ?></span>
                                </div>
                            </div>
                        </div>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center"
                                href="<?php echo e(route('backend.my-profile')); ?>"><?php echo e(__('messages.myprofile')); ?><i class="ph ph-user"></i></a>
                        </li>
                        <?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin|demo_admin')): ?>
                            <li>
                                <a class="dropdown-item d-flex justify-content-between align-items-center"
                                    href="<?php echo e(route('backend.settings.general')); ?>">
                                    <?php echo app('translator')->get('settings.title'); ?> <i class="ph ph-gear"></i>
                                </a>
                            </li>
                        <?php endif; ?>
                        ...
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center"
                                ...
                                <?php echo app('translator')->get('messages.logout'); ?><i class="ph ph-sign-out"></i>
                            </a>
                        </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u709483251/domains/madhutechnoworld.in/public_html/resources/views/backend/includes/header.blade.php ENDPATH**/ ?>
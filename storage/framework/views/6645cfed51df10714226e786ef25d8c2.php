...
?>
<header class="<?php echo e($currentRoute === 'user.login' && !in_array($currentRoute, $noAbsoluteRoutes) ? 'header-absolute' : ''); ?>">
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu py-xl-0">
        <div class="container-fluid navbar-inner">
            <div class="d-flex align-items-center justify-content-between w-100 landing-header">
                ...
                <?php echo $__env->make('frontend::components.partials.horizontal-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <ul class="navbar-nav align-items-center mb-0 list-inline justify-content-end">
                                <li class="nav-item dropdown dropdown-language-wrapper">
                                    <button class="btn btn-dark gap-3 px-3 dropdown-toggle" data-bs-toggle="dropdown"
                                        ...
                                        <img src="<?php echo e(asset('flags/' . App::getLocale() . '.png')); ?>" alt="flag" class="img-fluid me-2" style="width: 20px; height: auto; min-width: 15px;"
                                        onerror="this.onerror=null; this.src='<?php echo e(asset('flags/globe.png')); ?>';">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-language mt-0">
                                        <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a class="dropdown-item" href="<?php echo e(route('frontend.language.switch', $locale)); ?>">
                                                <span class="d-flex align-items-center gap-3">
                                                    <img src="<?php echo e(asset('flags/' . $locale . '.png')); ?>" alt="flag" class="img-fluid mr-2" style="width: 20px;height: auto;min-width: 15px;">
                                ...
                                <?php if(auth()->check()): ?>
                                    <?php if(auth()->user()->user_type == 'user'): ?>
                                        <li class="nav-item">
                                            <?php if(auth()->user()->is_subscribe == 0): ?>
                                                <button class="btn btn-warning-subtle font-size-14 text-uppercase subscribe-btn" onclick="window.location.href='<?php echo e(route('subscriptionPlan')); ?>'">
                                                    <?php echo e(__('frontend.subscribe')); ?>

                                                </button>
                                            <?php else: ?>
                                                <button class="btn btn-warning-subtle font-size-14 text-uppercase subscribe-btn" onclick="window.location.href='<?php echo e(route('subscriptionPlan')); ?>'">
                                                    <?php echo e(__('frontend.upgrade')); ?>
                                    ...
                                    <li class="nav-item flex-shrink-0 dropdown dropdown-user-wrapper">
                                        <a class="nav-link dropdown-user" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <img src="<?php echo e(setBaseUrlWithFileName(auth()->user()->file_url)); ?>" class="img-fluid user-image rounded-circle" alt="user image">
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end dropdown-user-menu border border-gray-900" aria-labelledby="navbarDropdown">
                                            <div class="bg-body p-3 d-flex justify-content-between align-items-center gap-3 rounded mb-4">
                                                <div class="d-inline-flex align-items-center gap-3">
                                                    <div class="image flex-shrink-0">
                                                        <img src="<?php echo e(setBaseUrlWithFileName(auth()->user()->file_url)); ?>" class="img-fluid dropdown-user-menu-image" alt="">
                                                    </div>
                                                    <div class="content">
                                                        <h6 class="mb-1"><?php echo e(auth()->user()->full_name ?? default_user_name()); ?></h6>
                                                        <span class="font-size-14 dropdown-user-menu-contnet"><?php echo e(auth()->user()->email); ?></span>
                                                    </div>
                                                </div>
                                                <div class="link">
                                                    <a href="<?php echo e(route('edit-profile')); ?>" class="link-body-emphasis">
                                            ...
                                            <ul class="d-flex flex-column gap-3 list-inline m-0 p-0">
                                                <li>
                                                    <a href="<?php echo e(route('watchList')); ?>" class="link-body-emphasis font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('frontend.my_watchlist')); ?></span>
                                                            <i class="ph ph-caret-right"></i>
                                                        </span>
                                                    </a>
                                                </li>

                                        <?php if(getCurrentProfileSession('is_child_profile') == 0): ?>
<li class="d-flex align-items-center justify-content-between py-2 <?php echo e(auth()->user()->pin ? 'border-bottom border-secondary' : ''); ?>">
    <a href="javascript:void(0);" class="link-body-emphasis font-size-14 d-flex align-items-center gap-2">
        <span class="fw-medium"><?php echo e(__('frontend.security_control')); ?></span>
    </a>
    ...
    <label class="toggle-switch mb-0 ms-2">
        <input
            ...
            id="security_toggle"
            value="1"
            data-security-url="<?php echo e(route('security-control')); ?>"
            data-disable-url="<?php echo e(route('disable-security')); ?>"
            <?php echo e(auth()->user()->is_parental_lock_enable ? 'checked' : ''); ?>
...
<li id="security_control_section" class="<?php echo e(auth()->user()->is_parental_lock_enable ? '' : 'd-none'); ?>">
 <a href="<?php echo e(route('security-control')); ?>" id="pinActionBtn" class="d-flex align-items-center justify-content-between py-2 text-decoration-none text-white">
    <div class="d-flex align-items-center gap-2">
        ...
        <?php if(empty(auth()->user()->pin)): ?>
            <?php echo e(__('frontend.set_pin')); ?>

        <?php else: ?>
            <?php echo e(__('frontend.change_pins')); ?>
...
<?php endif; ?>
                                                 ...
                                                 <li>
                                                    <a href="<?php echo e(route('unlock.videos')); ?>" class="link-body-emphasis font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('messages.lbl_unlock_videos')); ?></span>
                                                            <i class="ph ph-caret-right"></i>
                                                        </span>
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="<?php echo e(route('edit-profile')); ?>" class="link-body-emphasis font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('frontend.profile')); ?></span>
                                                            <i class="ph ph-caret-right"></i>
                                                        </span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('subscriptionPlan')); ?>" class="link-body-emphasis font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('frontend.subscription_plan')); ?></span>
                                                            <i class="ph ph-caret-right"></i>
                                                        </span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('accountSetting')); ?>" class="link-body-emphasis font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('frontend.account_setting')); ?></span>
                                                            <i class="ph ph-caret-right"></i>
                                                        </span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('payment-history')); ?>" class="link-body-emphasis font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('frontend.subscription_history')); ?></span>
                                                            <i class="ph ph-caret-right"></i>
                                                        </span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('transaction-history')); ?>" class="link-body-emphasis font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('frontend.pay_per_view_transactions')); ?></span>
                                                            <i class="ph ph-caret-right"></i>
                                                        </span>
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="<?php echo e(route('user-logout')); ?>" class="link-primary font-size-14">
                                                        <span class="d-flex align-items-center justify-content-between gap-3">
                                                            <span class="fw-medium"><?php echo e(__('frontend.logout')); ?></span>
                                                        </span>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <?php else: ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary font-size-14 login-btn">
            ...
            if (this.checked) {
                ...
                .then(data => {
                    if (data.status === 'success') {
                        ...
                        <?php if(auth()->check()): ?>
                            if (!<?php echo e(auth()->user()->pin ? 'true' : 'false'); ?>) {
...
<?php /**PATH /home/u709483251/domains/madhutechnoworld.in/public_html/Modules/Frontend/Resources/views/layouts/header.blade.php ENDPATH**/ ?>
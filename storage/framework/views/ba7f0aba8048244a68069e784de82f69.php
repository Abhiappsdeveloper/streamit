<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-lg-5 col-md-8 col-11 align-self-center">
                        <div class="user-login-card card my-5">
                            ...
                            <div class="text-center auth-heading">
                                ...
                                <a href="<?php echo e(route('user.login')); ?>" class="d-inline-block">
                                    <img src="<?php echo e($logo); ?>" class="img-fluid logo h-4 mb-4">
                                </a>
                                  
                                    <h5><?php echo e(__('frontend.sign_in_title')); ?> <?php echo e(app_name()); ?>!</h5>
                                <p class="fs-14"><?php echo e(__('frontend.sign_in_sub_title')); ?></p>
                            ...
                            <form action="post" id="login-form" class="requires-validation" data-toggle="validator"
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        placeholder="<?php echo e(__('frontend.enter_email')); ?>" aria-describedby="basic-addon1"
                                        required>
                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <label class="list-group-item d-flex align-items-center"><input
                                            ...
                                            type="checkbox"><?php echo e(__('frontend.remember_me')); ?></label>
                                    <a href="<?php echo e(url('/forget-password')); ?>"><?php echo e(__('frontend.forgot_password')); ?></a>
                                </div>
                                <div class="full-button text-center">
                                    <button type="submit" id="login-button" class="btn btn-primary w-100">
                                        <?php echo e(__('frontend.sign_in')); ?>

                                    </button>
                                    <p class="mt-2 mb-0 fw-normal"><?php echo e(__('frontend.not_have_account')); ?><a
                                            href="<?php echo e(route('register-page')); ?>"
                                            class="ms-1"><?php echo e(__('frontend.sign_up')); ?></a></p>
                                </div>
                                ...
                                <div class="full-button text-center">
                                    <?php if(setting('is_google_login') == 1): ?>
                                        <a href="<?php echo e(route('auth.google')); ?>" class="d-block">
                                            <span id="google-login" class="btn btn-dark w-100">
                                                ...
                                                <?php echo e(__('frontend.continue_with_google')); ?>

                                            </span>
                                        </a>
                                    <?php endif; ?>
                                    <?php if(setting('is_otp_login') == 1): ?>
                                        <a href="<?php echo e(route('otp-login')); ?>" class="d-block mt-3">
                                            <span id="otp-login" class="btn btn-dark w-100">
                                                <?php echo e(__('frontend.login_with_otp')); ?>

                                            </span>
                                        </a>
                                    <?php endif; ?>
                                    <?php if(setting('demo_login') == 1): ?>
                                        <a href="<?php echo e(route('admin-login')); ?>" class="d-block mt-3">
                                            <?php echo e(__('installer_messages.final.admin_panel')); ?></a>
                                    <?php endif; ?>
                                </div>
                            </form>
                        </div>
    ...
    <script src="<?php echo e(asset('js/auth.min.js')); ?>" defer></script>
    <script>
...
<?php echo $__env->make('frontend::layouts.auth_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u709483251/domains/madhutechnoworld.in/public_html/Modules/Frontend/Resources/views/auth/login.blade.php ENDPATH**/ ?>